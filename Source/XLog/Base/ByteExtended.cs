...
{
    internal static class ByteExtended
    {
        public static byte[] breakUp(this byte[] val, long index, long count)
        {
            ...
            {
                SimpleLogController.writeErrorLog(ex, "ByteExtended breakUp");
                return new byte[0];
            }
        }
        ...
        public static byte[] insertUnicodeString(this byte[] val, string content, int offsetIndex = 0)
        {
            ...
            {
                SimpleLogController.writeErrorLog(ex, "ByteExtended insertUnicodeString");
                return new byte[0];
            }
        }
