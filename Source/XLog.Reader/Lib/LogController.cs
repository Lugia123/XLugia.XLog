...
namespace XLugia.Lib.XLog.Reader.Lib
{
    internal class LogController
    {
        ...
        public static void writeSystemLog(string log, string codeRemarks)
        {
            try
            {
                ...
                {
                    LogWriter.getIns().writeLog(codeRemarks, LogType.getIns().info.system, "XLugia.Lib.XLog.Reader");
                    LogWriter.getIns().writeLog(log, LogType.getIns().info.system, "XLugia.Lib.XLog.Reader");
                }
            }
            catch { }
        }
        ...
        public static void writeErrorLog(string log, string codeRemarks)
        {
            try
            {
                ...
                if (IsEnableSystemLog)
                {
                    LogWriter.getIns().writeLog(codeRemarks, LogType.getIns().error.system, "XLugia.Lib.XLog.Reader");
                    LogWriter.getIns().writeLog(log, LogType.getIns().error.system, "XLugia.Lib.XLog.Reader");
                }
            }
            catch { }
        }
        ...
        public static void writeErrorLog(Exception error, string codeRemarks)
        {
            try
            {
                ...
                LogWriter.getIns().writeLog(sb.ToString(), LogType.getIns().error.system, "XLugia.Lib.XLog.Reader");
            }
            catch { }
        }
    }
